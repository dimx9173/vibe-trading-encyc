...
|---|---|---|---|
| 做空決策佔比 (Short Ratio) | 0.0% | R4 規則觸發 9.3% (放寬後) / V4 舊版 0% | ⚠️ 未達 (需 25-45%) |
| 評分卡兜底率 (Fallback Rate) | 34.7% | **0.0%** (V4 267 bars 實測) | ✅ 達標 |
| 最大回撤 (MDD) | 1.54% | **0.0%** (V4 267 bars 實測, 零交易) | ✅ 達標 |
| 總體淨盈虧 (PnL) | -1.51% | +0.00 (V4 保守全 HOLD) | ⚠️ 未達 (需轉正) |
| 平均盈虧比 (R:R) | 1.0:1 | 需交易樣本 | ⚠️ 未驗證 |
